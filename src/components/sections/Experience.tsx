          ...
          {TIMELINE_ITEMS.map((item, idx) => {
            ...
            return (
              <div key={item.id} className="relative">
                ...
                <div className="absolute -left-[36px] md:-left-[52px] top-1.5 w-6 h-6 rounded-full border-4 border-black bg-brand-primary dark:bg-yellow-400 flex items-center justify-center shadow-sm">
